        ...
        <div className={`grid grid-cols-1 sm:grid-cols-3 gap-10 mb-10 ${isRTL ? "text-right" : ""}`}>
          ...
          <div className={isRTL ? "sm:col-span-1 sm:order-3" : ""}>
            <div className={`flex items-center gap-3 mb-4 ${isRTL ? "flex-row-reverse" : ""}`}>
              <div className="w-9 h-9 rounded-full border-2 border-border overflow-hidden flex-shrink-0 hover:ring-2 hover:ring-foreground/20 dark:hover:ring-[hsl(263_80%_68%/0.35)] transition-all">
              ...
              {QUICK_LINKS.map((link) => (
                <li key={link.href}>
                  <button
                    ...
                    className="text-sm text-muted-foreground hover:text-foreground dark:hover:text-[hsl(263_80%_75%)] transition-colors duration-150"
                  >
            ...
            <div className="space-y-2.5">
              {[
                ...
                <a key={href} href={href} target={href.startsWith("mailto") ? undefined : "_blank"} rel="noopener noreferrer"
                  className="text-sm text-muted-foreground hover:text-foreground dark:hover:text-[hsl(263_80%_75%)] transition-colors flex items-center gap-1.5 group"
        ...
        <div className={`border-t border-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 ${isRTL ? "sm:flex-row-reverse" : ""}`}>
          <div className={`text-xs text-muted-foreground flex items-center gap-1.5 ${isRTL ? "flex-row-reverse" : ""}`}>
            ...
            <span className={`flex items-center gap-1 ${isRTL ? "flex-row-reverse" : ""}`}>
              {t.footer.builtWith}
              <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" className="text-foreground/35 dark:text-[hsl(263_80%_68%/0.65)]">
                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
              </svg>
              <span className="font-mono dark:text-[hsl(263_80%_70%/0.7)]">React + Tailwind</span>
            </span>
          </div>
          ...
          <div className={`flex items-center gap-3 ${isRTL ? "flex-row-reverse" : ""}`}>
            <button
              ...
              className="text-xs text-muted-foreground hover:text-foreground dark:hover:text-[hsl(263_80%_75%)] transition-colors flex items-center gap-1"
            >
              {t.footer.backToTop}
              <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
